...
triangular <- function(mat) {
  ...
  mat <- mat[correctOrder,1:NCOL(mat)] #Copiado de mas tarde
  ...
  #Si llegara a tener un 0 arriba de todo me va a molestar. Por lo qe primero ordeno la matriz para asegurarme un numero > 0. Y lo repito por cada columna (bajando por la diagonal)
    ...
    mat[i:NROW(mat),i:NCOL(mat)] <- mat[correctOrder,i:NCOL(mat)] #Reorganiza las columnas y las mete en una matrix temporal, en la qe ignora los valores qe ya corrigio
    ...
    mat[1,] <- mat[1,] / mat[1,1] #Normalizo la fila (si ya valia 1, no va a afectarme)
    print("Normalizada:")
    print(mat)
    ...
    for(t in 2:NROW(mat)) { #Qiero qe reste a las filas de la columna para volverlas cero.
        ...
        mat[t,] <- mat[t,] - mat[t,1] #A toda la fila le resta el primer valor
